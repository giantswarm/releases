...
### nginx-ingress-controller v0.34.1 ([Giant Swarm app v1.8.2](https://github.com/giantswarm/nginx-ingress-controller-app/blob/master/CHANGELOG.md#181---2020-07-31))
