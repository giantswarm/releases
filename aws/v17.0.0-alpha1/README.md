# :zap: Giant Swarm Release v17.0.0-alpha1 for AWS :zap:
...
> **_Warning:_** This is a **`alpha preview release`** intended only for testing Kubernetes v1.22 changes and
Control Groups v2 compatibility. It doesn't have any support for upgrades to and from.

**Known Issues**
- Java applications using an older `JRE` then v15 are known to not run properly because Control Groups v2 support was
added in `JRE` v15. The JVM is unable to identify memory limits. More details are available in the
