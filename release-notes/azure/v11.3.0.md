...
Flatcar Container Linux image, contrary to the CoreOS Container Linux image, has a license that has to be accepted. Please look into the instructions prior to upgrading your clusters [here](https://github.com/giantswarm/releases/blob/master/announcements/11-3-0-azure-flatcar-license-approval.md)
