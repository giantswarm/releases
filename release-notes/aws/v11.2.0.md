...
- The number of Persistent Volumes is now limited statically, currently to 20 per node. This mitigates a problem customers had, where Kubernetes would attempt to calculate the limit of volumes per node, but the limit was not taken into consideration by the scheduler. https://github.com/giantswarm/k8scloudconfig/pull/685

- The IAM policy expected by aws-operator has been modified and many permissions have been removed. Also the permission to access service quotas of the AWS account has been added. https://github.com/giantswarm/aws-operator/pull/1965
