...
We are pleased to announce that this new branch (10.1.0) contains the much anticipated Node Pools feature and will contain all
other features thereafter such as High Availability of Masters and Spot Instances which are due to be released next year. 

We therefore kindly remind you that from this release and for a period of six months onwards, 
to give you a chance to move your clusters, we will be supporting both this new branch and the 'Legacy' 9.0.0 branch which we will continue to maintain during this period. This means that you will not be able to upgrade your clusters but will need move your clusters instead! 
