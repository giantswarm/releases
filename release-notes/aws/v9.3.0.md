...
### aws-operator [v5.7.0](https://github.com/giantswarm/aws-operator/releases/tag/v5.7.0)
- [Replaced CoreOS with Flatcar Container Linux](https://www.giantswarm.io/blog/time-to-catch-a-new-train-flatcar-linux).
