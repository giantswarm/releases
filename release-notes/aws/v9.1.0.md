...
**Note** This is a legacy port of [AWS release v11.0.0](https://github.com/giantswarm/releases/blob/master/release-notes/aws/v11.0.0.md) with Kubernetes 1.16.3 for non-node pool clusters (i.e. cluster versions < 10).
