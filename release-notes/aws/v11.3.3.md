...
This release fixes an issue where `cert-manager` could be killed for exceeding its memory limit. This in turn means that SSL certificates
wouldn't be automatically renewed and could therefore expire.
