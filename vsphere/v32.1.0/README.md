# :zap: Giant Swarm Release v32.1.0 for vSphere :zap:
...
- cluster-vsphere from v3.0.0 to v3.4.0
- Flatcar from v4230.2.3 to [v4230.2.4](https://www.flatcar.org/releases/#release-4230.2.4)
- os-tooling from v1.26.1 to v1.26.2

### cluster-vsphere [v3.0.0...v3.4.0](https://github.com/giantswarm/cluster-vsphere/compare/v3.0.0...v3.4.0)
...
- cert-exporter from v2.9.10 to v2.9.12
- cert-manager from v3.9.2 to v3.9.4
- coredns from v1.27.0 to v1.28.2
- etcd-defrag from v1.1.0 to v1.2.2
- etcd-k8s-res-count-exporter from v1.10.8 to v1.10.9
- k8s-audit-metrics from v0.10.7 to v0.10.8
- node-exporter from v1.20.6 to v1.20.7
- observability-bundle from v2.2.2 to v2.3.2
- security-bundle from v1.12.0 to v1.14.0
- vertical-pod-autoscaler from v6.1.0 to v6.1.1
- vertical-pod-autoscaler-crd from v4.1.0 to v4.1.1
...
### cert-exporter [v2.9.10...v2.9.12](https://github.com/giantswarm/cert-exporter/compare/v2.9.10...v2.9.12)
...
### etcd-defrag [v1.1.0...v1.2.2](https://github.com/giantswarm/etcd-defrag-app/compare/v1.1.0...v1.2.2)
...
### etcd-k8s-res-count-exporter [v1.10.8...v1.10.9](https://github.com/giantswarm/etcd-kubernetes-resources-count-exporter/compare/v1.10.8...v1.10.9)

#### Changed

- Go: Update dependencies.

### k8s-audit-metrics [v0.10.7...v0.10.8](https://github.com/giantswarm/k8s-audit-metrics/compare/v0.10.7...v0.10.8)

#### Changed

- Go: Update dependencies.

### node-exporter [v1.20.6...v1.20.7](https://github.com/giantswarm/node-exporter-app/compare/v1.20.6...v1.20.7)
...
### vertical-pod-autoscaler [v6.1.0...v6.1.1](https://github.com/giantswarm/vertical-pod-autoscaler-app/compare/v6.1.0...v6.1.1)
...
### vertical-pod-autoscaler-crd [v4.1.0...v4.1.1](https://github.com/giantswarm/vertical-pod-autoscaler-crd/compare/v4.1.0...v4.1.1)
