# :zap: Giant Swarm Release v35.0.1 for vSphere :zap:
...
### cluster-vsphere [v5.1.4...v9.0.0](https://github.com/giantswarm/cluster-vsphere/compare/v5.1.4...v9.0.0)
...
### cloud-provider-vsphere [v2.4.0...v2.5.1](https://github.com/giantswarm/cloud-provider-vsphere-app/compare/v2.4.0...v2.5.1)
...
### kube-vip-cloud-provider [v0.3.0...v0.3.2](https://github.com/giantswarm/kube-vip-cloud-provider-app/compare/v0.3.0...v0.3.2)
...
### vsphere-csi-driver [v3.4.3...v3.4.6](https://github.com/giantswarm/vsphere-csi-driver-app/compare/v3.4.3...v3.4.6)
