...
3. [Prometheus Operator v0.4.0](https://github.com/giantswarm/prometheus-operator-app/blob/master/CHANGELOG.md#040---2020-10-15) upgrades prometheus-operator, prometheus, alertmanager, etc. It also adapts global templating variables to work with upstream chart location and name change from `prometheus-operator` (EOL in Nov 2020) to `kube-prometheus-stack`
