# :zap: Giant Swarm Release v35.0.1 for VMware Cloud Director :zap:

## Changes compared to v34.5.0

### Components

- cluster-cloud-director from v3.2.3 to v7.0.0
...
### cluster-cloud-director [v3.2.3...v7.0.0](https://github.com/giantswarm/cluster-cloud-director/compare/v3.2.3...v7.0.0)
