# :zap: Giant Swarm Release v33.0.0 for VMware Cloud Director :zap:

## Changes compared to v32.0.0

### Components

- cluster-cloud-director from v1.0.0 to v2.0.2
...
### cluster-cloud-director [v1.0.0...v2.0.2](https://github.com/giantswarm/cluster-cloud-director/compare/v1.0.0...v2.0.2)
