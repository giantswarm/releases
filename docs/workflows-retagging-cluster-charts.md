...
1. **Pulls** the original chart `cluster-aws:7.2.5` from `giantswarmpublic.azurecr.io/cluster-catalog`
...
5. **Pushes** `release-aws:34.0.0` to `giantswarmpublic.azurecr.io/cluster-catalog`
