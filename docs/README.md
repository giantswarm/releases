...
- **Summarize** (`summarize.yaml`) - AI-powered summary of upstream Kubernetes/Flatcar breaking changes via `/summarize` slash command
...
| Summarize Upstream Changes | On PR comment (`/summarize`) | ❌ |
