...
This is Giant Swarm release preparing towards Kubernetes 1.25 with migration PSPs. Thi is unsecured release by default disabling all PSPs from all components. Please do not upgrade to that release directly and talk to your Account Engineer for more details.
