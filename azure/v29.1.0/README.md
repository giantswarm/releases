...
- Flatcar from v3815.2.5 to [v3975.2.1](https://www.flatcar.org/releases#release-3975.2.1)
- Kubernetes from v1.29.7 to [v1.29.9](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.29.md#changelog-since-v1297)

### cluster-azure [v1.0.0...v1.3.0](https://github.com/giantswarm/cluster-azure/compare/v1.0.0...v1.3.0)
