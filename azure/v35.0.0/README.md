...
- cluster-azure from v5.4.1 to v6.5.0
...
### cluster-azure [v5.4.1...v6.5.0](https://github.com/giantswarm/cluster-azure/compare/v5.4.1...v6.5.0)
...
- Added cluster-autoscaler v1.35.0-1
...
### cluster-autoscaler [v1.35.0-1](https://github.com/giantswarm/cluster-autoscaler-app/releases/tag/v1.35.0-1)
