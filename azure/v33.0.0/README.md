# :zap: Giant Swarm Release v33.0.0 for Azure :zap:

## Changes compared to v32.0.0

### Components

- cluster-azure from v3.0.0 to v4.0.2
...
### cluster-azure [v3.0.0...v4.0.2](https://github.com/giantswarm/cluster-azure/compare/v3.0.0...v4.0.2)
